 ...
 * @author rauln
 */
public class TestBeans extends javax.swing.JFrame {

    /**
     * Creates new form TestBeans
     */
    public TestBeans() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestBeans.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {          
                new TestBeans().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private nuevoJPanel.Fondo fondo1;
